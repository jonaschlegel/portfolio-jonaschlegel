...
<Image src={AdventuressCoverConcept} alt="Concept design for the cover image of the Adventuress Archaeology Journal" className="mt-10" />
<p className="caption">Fig. 1: Shows the concept sketches, thoughts and information behind the cover design</p>
...
<Image src={AdventuressCoverDesign} alt="The actualy design drawing for the cover" className="mt-10" />
<p className="caption">Fig. 2: The design of the finished cover image</p>
